...
<!--
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <p id="profile-name" class="profile-name-card">Ingrese patente</p>
            <form class="form-signin" method="post" action="nexo.php">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="submitIngresarPatente">Ingresar Vehiculo</button>
            </form><!-- /form -->
        </div><!-- /card-container -->
    </div><!-- /container -->
</body>
